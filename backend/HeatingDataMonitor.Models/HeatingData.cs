...
public class HeatingData
{
    ...
    public bool DI_0 { get; set; }
    public bool DI_1 { get; set; }
    public bool DI_2 { get; set; }
    public bool DI_3 { get; set; }
    public bool A_W_0 { get; set; }
    public bool A_W_1 { get; set; }
    public bool A_W_2 { get; set; }
    public bool A_W_3 { get; set; }
    public bool A_EA_0 { get; set; }
    public bool A_EA_1 { get; set; }
    public bool A_EA_2 { get; set; }
    public bool A_EA_3 { get; set; }
    public bool A_EA_4 { get; set; }
    public bool A_PHASE_0 { get; set; }
    public bool A_PHASE_1 { get; set; }
    public bool A_PHASE_2 { get; set; }
    public bool A_PHASE_3 { get; set; }
    public bool A_PHASE_4 { get; set; }
}
